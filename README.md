...
The top 4 rows will change depending on what page you're on. You can consult the [Page ID table](https://github.com/zsd7200/plza-shiny-tool/blob/master/docs/PAGE_ID.md) for more information.
...
5. Set `zoneId` equal to the desired Wild Zone's number, or other ID from [this table](https://github.com/zsd7200/plza-shiny-tool/blob/master/docs/ZONE_ID.md) (more IDs coming soon).
6. Upload code to board. You may need to press the reset button/bridge reset pins during upload.

## In-Game Setup Instructions

See [this documentation](https://github.com/zsd7200/plza-shiny-tool/blob/master/docs/INSTRUCTIONS.md) for instructions, and see [this documentation](https://github.com/zsd7200/plza-shiny-tool/blob/master/docs/ZONE_ID.md) for explanations of macros.
